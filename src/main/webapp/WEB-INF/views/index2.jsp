  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <!-- 왼쪽 파트! -->
          <c:if test="${house_deal_dto_list ne null}">
					...
					<div class="col-md-12">
						<div class="content-panel">
							...
							<div class="row" style="margin-left: 5px">
								...
								<form action="${root}/house" id="searchForm">
									...
									<div class="col-md-6">
										<input type="text" name="word" class="form-control" id="search" placeholder="검색어를 입력하세요">
									</div>
									<div class="col-md-3">
										<button type="submit" form="searchForm" class="btn btn-theme">검색</button>
									</div>
								</form>
							</div>	
							<hr>						
							<table class="table">
								...
								<tbody>
									<c:forEach var="dto" items="${house_deal_dto_list}">
									<tr>
										<td>${dto.no}</td>
										<td>${dto.dong}</td>
	    ...
	    <c:if test="${house_deal_dto ne null}">
          <div class="col-lg-6 ds">
            ...
            <div style="height: 1000px">
            	...
            	<div>
            		<h4><i class="fa fa-angle-right"></i> 주택명: ${house_deal_dto.aptName} </h4>
            		<h4><i class="fa fa-angle-right"></i> 거래금액: ${house_deal_dto.dealAmount} </h4>
            		<h4><i class="fa fa-angle-right"></i> 월세금액: ${house_deal_dto.recentMoney eq null ? "없음" : house_deal_dto.rentMoney}</h4>
            		<h4><i class="fa fa-angle-right"></i> 건축연도: ${house_deal_dto.buildYear} </h4>
            		<h4><i class="fa fa-angle-right"></i> 전용면적: ${house_deal_dto.area} </h4>
            		<h4><i class="fa fa-angle-right"></i> 거래일: ${house_deal_dto.dealYear}년 ${house_deal_dto.dealMonth}월 ${house_deal_dto.dealDay}일 </h4>
            		<h4><i class="fa fa-angle-right"></i> 법정동: ${house_deal_dto.dong} </h4>
            		<h4><i class="fa fa-angle-right"></i> 지번: ${house_deal_dto.jibun} </h4>
      				<button type="button" onclick="location.href='house?act=mapindex&key=${house_deal_dto.aptName}'"class="btn btn-theme btn-block" id="btn_detail">
      					상세 정보 확인
      				</button>
            	</div>
            </div>
			...
			<div class="modal-content">
				...
				<form action="${root}/user/login" method="post" id="loginForm">
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="loginpw">Password</label> <input type="password" class="form-control" placeholder="Password" name="userpwd" id="loginpwd">
						</div>
					</div>
					<!-- Modal footer -->
